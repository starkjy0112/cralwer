...
class GimcheonGosiCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        resp = self.session.post(
            f"{LIST_URL}?seCode=01&mId=1202180100", data=data, timeout=15
        )
        resp.encoding = "utf-8"
        ...
        for tr in rows:
            ...
            if a_tag:
                ...
                if data_action:
                    ...
                    detail_url = f"{LIST_URL}?seCode=01&mId=1202180100"
            else:
