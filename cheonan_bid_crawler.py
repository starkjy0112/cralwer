...
"""
천안시청 입찰공고 크롤러
https://www.cheonan.go.kr/prog/saeolGosi/GOSI_04/kor/sub02_02_06/list.do
GET 기반, saeolGosi 패턴, 20건/페이지
"""
import math
import re
import requests
...
LIST_URL = f"{BASE_URL}/prog/saeolGosi/GOSI_04/kor/sub02_02_06/list.do"
PAGE_SIZE = 20
ORGANIZATION_NAME = "천안시청"


class CheonanBidCrawler:
    """천안시청 입찰공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for tr in rows:
            ...
            if btn:
                ...
                href = a_tag.get("href", "")
                detail_url = f"{BASE_URL}{href}" if href.startswith("/") else LIST_URL
            else:
