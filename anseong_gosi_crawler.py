...
LIST_URL = f"{BASE_URL}/portal/saeol/gosiList.do?mId=0501040000"
PAGE_SIZE = 10
ORGANIZATION_NAME = "안성시청"


class AnseongGosiCrawler:
    """안성시청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        if table:
            ...
            for tr in rows:
                ...
                if m_id:
                    detail_url = f"{BASE_URL}/portal/saeol/gosiView.do?notAncmtMgtNo={m_id.group(1)}&mId=0501040000"
                else:
                    detail_url = ""
