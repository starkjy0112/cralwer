...
"""
철원군청 고시/공고 크롤러
https://www.cwg.go.kr/www/selectBbsNttList.do?key=1226&bbsNo=25&searchCnd=SJ
GET 기반, p-table, 10건/페이지
컬럼: 번호, 제목, 부서, 파일, 조회수, 작성일
"""
import math
import re
...
BASE_URL = "https://www.cwg.go.kr"
LIST_URL = f"{BASE_URL}/www/selectBbsNttList.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "철원군청"


class CheorwonGosiCrawler:
    """철원군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            title_td = row.select_one("td.p-subject") or tds[1]
