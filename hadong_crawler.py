...
BASE_URL = "https://www.hadong.go.kr"
LIST_URL = f"{BASE_URL}/media/00012.web"
PAGE_SIZE = 10
ORGANIZATION_NAME = "하동군청"
...
class HadongCrawler:
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[{ORGANIZATION_NAME} 공고고시] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = HadongCrawler()
    print("=== '공고' 검색 ===")
