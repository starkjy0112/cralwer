...
"""
양주시청 입찰공고 크롤러
https://www.yangju.go.kr/www/contents.do?key=212
...
BASE_URL = "https://eminwon.yangju.go.kr"
...
class YangjuBidCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        table = soup.find("table", id="list2")
        if not table:
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[양주시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items
