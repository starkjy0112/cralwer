...
"""
예산군청 입찰 크롤러
https://www.yesan.go.kr/prog/saeolGosi/02/kor/sub04_03_03/list.do
...
LIST_URL = f"{BASE_URL}/prog/saeolGosi/02/kor/sub04_03_03/list.do"
PAGE_SIZE = 20
ORGANIZATION_NAME = "예산군청"


class YesanBidCrawler:
    """예산군청 입찰 크롤러"""
