...
LIST_PATH = "/www/open_administration/city_news/notification"
LIST_URL = f"{BASE_URL}{LIST_PATH}"
PAGE_SIZE = 10
ORGANIZATION_NAME = "보성군청"


class BoseongCrawler:
    """보성군청 공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            detail_url = f"{BASE_URL}{href}" if href.startswith("/") else (href if href.startswith("http") else LIST_URL)
