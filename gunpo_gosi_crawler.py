...
"""
군포시청 고시공고 크롤러
https://www.gunpo.go.kr/www/selectEminwonNoticeList.do?key=3907&Not_ancmt_se_code=01&notAncmtSeCd=01
GET 기반, 10건/페이지
"""
import math
import re
...
BASE_URL = "https://www.gunpo.go.kr"
LIST_URL = f"{BASE_URL}/www/selectEminwonNoticeList.do"
PAGE_SIZE = 10


class GunpoGosiCrawler:
    """군포시청 고시공고 크롤러"""
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[군포시청 고시공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = GunpoGosiCrawler()
    print("=== '공고' 검색 ===")
