...
"""
봉화군청 입찰공고 크롤러
https://www.bonghwa.go.kr/portal/saeol/gosi/list.do?seCode=02&mid=0201040000
...
PAGE_SIZE = 10
ORGANIZATION_NAME = "봉화군청"


class BonghwaBidCrawler:
    """봉화군청 입찰공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        resp = self.session.post(
            f"{LIST_URL}?seCode=02&mid=0201040000", data=data, timeout=15
        )
        resp.encoding = "utf-8"
        ...
        for tr in rows:
            ...
            if a_tag:
                ...
                if data_action:
                    ...
                    detail_url = f"{LIST_URL}?seCode=02&mid=0201040000"
            else:
