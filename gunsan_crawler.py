...
"""
군산시청 고시공고 크롤러
https://eminwon.gunsan.go.kr/emwp/gov/mogaha/ntis/web/ofr/action/OfrAction.do
POST 기반 (eminwon), 10건/페이지
"""
import math
import re
...
EMINWON_BASE = "https://eminwon.gunsan.go.kr"
...
class GunsanCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        resp = self.session.post(ACTION_URL, data=data, timeout=60)
        resp.encoding = "utf-8"
