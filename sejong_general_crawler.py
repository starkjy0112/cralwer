...
LIST_URL = f"{BASE_URL}/prog/publicNotice/kor/sub02_030301/C1_1/list.do"
PAGE_SIZE = 100


class SejongGeneralCrawler:
    """세종특별자치시청 일반공고 크롤러"""
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[세종특별자치시청 일반공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = SejongGeneralCrawler()
    print("=== 전체 조회 (3페이지) ===")
