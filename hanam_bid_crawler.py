...
"""
하남시청 입찰공고 크롤러
https://www.hanam.go.kr/www/selectGosiList.do?key=175&not_ancmt_se_code=02
GET 기반, 10건/페이지
...
class HanamBidCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            if href.startswith("./"):
                ...
                detail_url = href if href.startswith("http") else f"{LIST_URL}?key=175&not_ancmt_se_code=02"
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[하남시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = HanamBidCrawler()
    print("=== '공고' 검색 ===")
