...
"""
고성군청(강원) 고시공고 크롤러
https://www.goseong.go.kr/board/list.goseong?boardId=BBS_0000015&menuCd=DOM_000000103001014000&searchType=DATA_TITLE
GET 기반, 10건/페이지, table.list01
"""
import math
import re
...
BASE_URL = "https://www.goseong.go.kr"
LIST_URL = f"{BASE_URL}/board/list.goseong"
BOARD_ID = "BBS_0000015"
MENU_CD = "DOM_000000103001014000"
PAGE_SIZE = 10
ORGANIZATION_NAME = "고성군청(강원)"


class GoseongGwCrawler:
    """고성군청(강원) 고시공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        items = []
        table = soup.select_one("table.list01")
        if not table:
        ...
        for tr in rows:
            ...
            if len(tds) < 7:
                continue
            # 번호, 고시공고번호, 제목, 담당부서, 작성일, 게재종료일자, 조회
