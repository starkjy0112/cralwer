...
GET 기반, 10건/페이지, table.p-table.simple.list
"""
import math
import re
import requests
...
BASE_URL = "https://www.wonju.go.kr"
LIST_URL = f"{BASE_URL}/www/selectBbsNttList.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "원주시청"


class WonjuGosiCrawler:
    """원주시청 원주시 공고 크롤러"""
