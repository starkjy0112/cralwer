...
"""
김포시청 입찰공고 크롤러
https://www.gimpo.go.kr/portal/ntfcPblancList.do?key=3915&cate_cd=2&searchCnd=40900000000
GET 기반, 10건/페이지
"""
import math
import re
...
class GimpoBidCrawler:
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[김포시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = GimpoBidCrawler()
    print("=== '공고' 검색 ===")
