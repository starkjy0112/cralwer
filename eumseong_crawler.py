...
"""
음성군청 고시/공고 크롤러
https://www.eumseong.go.kr/www/selectEminwonList.do?key=352
GET 기반, 10건/페이지
"""
import math
import re
...
BASE_URL = "https://www.eumseong.go.kr"
LIST_URL = f"{BASE_URL}/www/selectEminwonList.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "음성군청"


class EumseongCrawler:
    """음성군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for tr in tbody.find_all("tr"):
            ...
            date = tds[3].get_text(strip=True).replace(".", "-") if len(tds) > 3 else ""
        ...
        if not total_count and items:
            # Estimate from first item number or pagination
