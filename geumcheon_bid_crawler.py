# -*- coding: utf-8 -*-
"""
금천구청 입찰공고 크롤러 (서울계약마당 iframe)
https://www.geumcheon.go.kr/portal/contents.do?key=424
→ contract.seoul.go.kr pubBidInfoFrame.do (ps0_setOfficeCd=4800)
"""
import math
import re
import requests
...
PAGE_SIZE = 10
ORGANIZATION_NAME = "금천구청"


class GeumcheonBidCrawler:
    """금천구청 입찰공고 크롤러 (서울계약마당)"""
    ...
    def _fetch_page(self, keyword, page):
        params = {
            ...
            "ps_t2OfficeCd": "4",
            "ps_setOfficeCd": "5100",
            "ps_firstPage": "A" if page == 1 else "",
            "ps_selectForm": "0",
            "ps0_t2OfficeCd": "4",
            "ps0_setOfficeCd": "4800",
            "ps_currentPageNo": str(page),
            "ps_recordCountPerPage": str(PAGE_SIZE),
        }
        if keyword:
            params["ps0_bidTtl"] = keyword
