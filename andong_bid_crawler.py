...
"""
안동시청 입찰정보 크롤러
https://www.andong.go.kr/portal/saeol/gosi/list.do?seCode=02&mId=0401090000
POST 기반, 10건/페이지, bod_list, href 직접 링크
"""
import math
import re
import requests
...
BASE_URL = "https://www.andong.go.kr"
LIST_URL = f"{BASE_URL}/portal/saeol/gosi/list.do"
MID = "0401090000"
PAGE_SIZE = 10
ORGANIZATION_NAME = "안동시청"


class AndongBidCrawler:
    """안동시청 입찰정보 크롤러"""
