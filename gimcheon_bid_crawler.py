...
"""
김천시청 입찰정보 크롤러
https://www.gc.go.kr/portal/saeol/gosi/list.do?seCode=02&mId=1202120100
POST 기반, table.bod_list, saeol/gosi 패턴, 10건/페이지
"""
import math
import re
        ...
        for tr in rows:
            ...
            if a_tag:
                ...
                if data_action:
                    ...
                    detail_url = f"{LIST_URL}?seCode=02&mId=1202120100"
            else:
            ...
            # If 6 columns: 번호, 고시번호, 제목, 파일, 담당부서, 등록일
            if len(tds) >= 6:
