...
"""
경주시청 입찰공고 크롤러
https://www.gyeongju.go.kr/open_content/ko/page.do?mnu_uid=424
POST 기반, 10건/페이지
"""
import math
import re
...
PAGE_SIZE = 10
ORGANIZATION_NAME = "경주시청"


class GyeongjuBidCrawler:
    """경주시청 입찰공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        resp = self.session.post(LIST_URL, data=data, params={"mnu_uid": "424"}, timeout=15)
        resp.encoding = "utf-8"
