...
"""
강릉시청 일반공고 크롤러
https://www.gn.go.kr/www/selectGosiNttList.do?key=263&searchGosiSe=01,04,06&searchCnd=ALL
GET 기반, 10건/페이지, table.bbs_default.list
"""
import math
import re
...
BASE_URL = "https://www.gn.go.kr"
LIST_URL = f"{BASE_URL}/www/selectGosiNttList.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "강릉시청"


class GangneungGosiCrawler:
    """강릉시청 일반공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        items = []
        table = soup.select_one("table.bbs_default") or soup.select_one("table")
        if not table:
