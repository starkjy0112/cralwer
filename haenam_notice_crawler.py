...
"""
해남군청 고시공고(게시판) 크롤러
https://www.haenam.go.kr/planweb/board/list.9is?contentUid=...&boardUid=...
GET 기반, table 5열 (번호/제목/작성자/일자/조회), nowPageNum 파라미터
"""
import math
import re
import requests
...
CONTENT_UID = "18e3368f5d745106015de961fbbd205e"
BOARD_UID = "18e3368f644b01470164eeb23d7b30f5"
LIST_URL = f"{BASE_URL}/planweb/board/list.9is"
PAGE_SIZE = 10
ORGANIZATION_NAME = "해남군청"


class HaenamNoticeCrawler:
    """해남군청 고시공고(게시판) 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            if href.startswith("./"):
                detail_url = f"{BASE_URL}/planweb/board/{href[2:]}"
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[{ORGANIZATION_NAME} 게시판] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = HaenamNoticeCrawler()
