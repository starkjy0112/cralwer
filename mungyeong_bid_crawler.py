...
"""
문경시청 입찰공고 크롤러
https://www.gbmg.go.kr/portal/saeol/gosi/list.do?seCode=02&mId=0301080000
        ...
        for tr in rows:
            ...
            if a_tag:
                ...
                if data_action:
                    ...
                    detail_url = f"{LIST_URL}?seCode=02&mId=0301080000"
            else:
