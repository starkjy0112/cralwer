...
BASE_URL = "https://www.yp21.go.kr"
LIST_URL = f"{BASE_URL}/www/selectBbsNttList.do"
PAGE_SIZE = 10


class YangpyeongCrawler:
    """양평군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            title_td = row.select_one("td.p-subject")
            if not title_td:
                title_td = tds[1]
            ...
            date = date_el.get("datetime", date_el.get_text(strip=True)) if date_el else tds[3].get_text(strip=True)
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[양평군청 고시/공고] 완료: 총 {len(all_items)}건")
        return all_items
