...
class YeongcheonGosiCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            num_td = row.select_one("td.num") or row.select_one("td.list_num")
            ...
            title_td = row.select_one("td.tit") or row.select_one("td.list_tit") or row.select_one("td.taL")
            if not title_td:
                title_td = tds[2]
            ...
            date_td = row.select_one("td.date") or row.select_one("td.list_date")
