...
"""
은평구청 고시/공고 크롤러
https://www.ep.go.kr/www/selectEminwonList.do?key=754&notAncmtSeCode=01
GET 기반, eminwon 시스템, table.responsive, 10건/페이지
"""
import math
import re
...
PAGE_SIZE = 10
ORGANIZATION_NAME = "은평구청"


class EunpyeongGosiCrawler:
    """은평구청 고시/공고 크롤러"""
