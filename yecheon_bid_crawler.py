...
"""
예천군청 입찰정보 크롤러
https://www.ycg.kr/open.content/ko/administrative/news/tender.new/
...
LIST_URL = f"{BASE_URL}/open.content/ko/administrative/news/tender.new/"
PAGE_SIZE = 10
ORGANIZATION_NAME = "예천군청"


class YecheonBidCrawler:
    """예천군청 입찰정보 크롤러"""
