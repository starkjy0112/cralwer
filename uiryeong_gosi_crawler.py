...
"""
의령군청 공고/고시 크롤러
https://www.uiryeong.go.kr/board/list.uiryeong?boardId=BBS_0000070&menuCd=DOM_000000203003001001&contentsSid=201
GET 기반, table.list01, 10건/페이지, startPage 파라미터
"""
import math
import re
...
BASE_URL = "https://www.uiryeong.go.kr"
LIST_URL = f"{BASE_URL}/board/list.uiryeong"
BOARD_ID = "BBS_0000070"
MENU_CD = "DOM_000000203003001001"
PAGE_SIZE = 10
ORGANIZATION_NAME = "의령군청"


class UiryeongGosiCrawler:
    """의령군청 공고/고시 크롤러"""
