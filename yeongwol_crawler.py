...
"""
영월군청 고시/공고 크롤러
https://www.yw.go.kr/www/selectBbsNttList.do?key=273&bbsNo=17&searchCnd=SJ
...
BASE_URL = "https://www.yw.go.kr"
LIST_URL = f"{BASE_URL}/www/selectBbsNttList.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "영월군청"


class YeongwolCrawler:
    """영월군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        total_count = 0
        # 첫 번째 row의 번호에서 총 건수 추출 (고시공고번호가 첫 컬럼)
        # pagination 기반 추정
