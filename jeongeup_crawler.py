...
"""
정읍시청 고시공고 크롤러
http://eminwon.jeongeup.go.kr/emwp/gov/mogaha/ntis/web/ofr/action/OfrAction.do
...
EMINWON_BASE = "http://eminwon.jeongeup.go.kr"
...
PAGE_SIZE = 10
ORGANIZATION_NAME = "정읍시청"


class JeongeupCrawler:
    """정읍시청 고시공고 크롤러"""
