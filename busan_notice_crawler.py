...
"""
부산광역시청 통합공지사항 크롤러
https://www.busan.go.kr/nbnews
POST 기반, 10건/페이지, curPage 방식
"""
import math
import re
...
LIST_URL = f"{BASE_URL}/nbnews"
PAGE_SIZE = 10


class BusanNoticeCrawler:
    """부산광역시청 통합공지사항 크롤러"""
    ...
    def _fetch_page(self, keyword, page, start_date=None, end_date=None):
        params = {
            "curPage": page,
            "srchBeginDt": start_date if start_date else "",
            "srchEndDt": end_date if end_date else "",
        }
        if keyword:
            params["srchKey"] = "sj"
