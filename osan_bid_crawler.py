...
"""
오산시청 입찰공고 크롤러
https://www.osan.go.kr/portal/saeol/gosi/list.do?mId=0302060000
POST 기반, 10건/페이지
"""
import math
import re
...
BASE_URL = "https://www.osan.go.kr"
LIST_URL = f"{BASE_URL}/portal/saeol/gosi/list.do"
MID = "0302060000"
PAGE_SIZE = 100


class OsanBidCrawler:
    """오산시청 입찰공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        # 총 건수: first row number as fallback
        total_count = 0
        items = []
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[오산시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items
