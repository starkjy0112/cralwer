...
"""
군포시청 입찰공고 크롤러
https://www.gunpo.go.kr/www/selectEminwonNoticeList.do?key=3903&Not_ancmt_se_code=02&notAncmtSeCd=02
GET 기반, 10건/페이지
"""
import math
import re
...
class GunpoBidCrawler:
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[군포시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = GunpoBidCrawler()
    print("=== '공고' 검색 ===")
