...
"""
창녕군청 고시/공고 크롤러
https://www.cng.go.kr/03517/01553.web
...
BASE_URL = "https://www.cng.go.kr"
LIST_URL = f"{BASE_URL}/03517/01553.web"
PAGE_SIZE = 10
ORGANIZATION_NAME = "창녕군청"


class ChangnyeongGosiCrawler:
    """창녕군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for a in links:
            href = a.get("href", "")
            # text1wrap 또는 wrap1texts 지원
            title_span = a.select_one("span.wrap1texts") or a.select_one("span.text1wrap")
            if not title_span:
                continue
...
if __name__ == "__main__":
    crawler = ChangnyeongGosiCrawler()
    print("=== '공고' 검색 ===")
