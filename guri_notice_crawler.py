...
"""
구리시청 공지사항 크롤러
https://www.guri.go.kr/www/selectBbsNttList.do?key=380&bbsNo=36&searchCnd=SJ
GET 기반, 10건/페이지
"""
import math
import re
...
class GuriNoticeCrawler:
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[구리시청 공지사항] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = GuriNoticeCrawler()
    print("=== '공고' 검색 ===")
