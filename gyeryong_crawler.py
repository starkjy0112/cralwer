...
"""
계룡시청 고시/공고 크롤러
https://gyeryong.go.kr/kr/html/sub03/030102.html
...
BASE_URL = "https://gyeryong.go.kr"
LIST_PATH = "/kr/html/sub03/030102.html"
LIST_URL = BASE_URL + LIST_PATH
PAGE_SIZE = 10
ORGANIZATION_NAME = "계룡시청"


class GyeryongCrawler:
    """계룡시청 고시/공고 크롤러"""
        ...
        if table:
            ...
            for tr in rows:
                ...
                if href and not href.startswith("http"):
                    detail_url = BASE_URL + "/kr/html/sub03/030102.html" + href
                else:
                    detail_url = href
