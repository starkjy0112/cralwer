...
"""
태안군청 입찰 크롤러
https://www.taean.go.kr/kor/sub02_03_02.do
iframe -> eminwon POST 기반, OfrAction.do, not_ancmt_se_code=02
"""
import math
import re
...
class TaeanBidCrawler:
    ...
    def _init_session(self):
        if not self._initialized:
            try:
                self.session.get(
                    f"{JSP_URL}?not_ancmt_se_code=02&list_gubun=A",
                    timeout=15
                )
            except Exception:
                pass
