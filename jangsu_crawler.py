...
"""
장수군청 고시공고 크롤러
https://www.jangsu.go.kr/index.jangsu?menuCd=DOM_000000102001005000
iframe -> eminwon (OfrNotAncmtL.jsp -> OfrAction.do), POST 기반, 10건/페이지
...
EMINWON_BASE = "https://eminwon.jangsu.go.kr"
ACTION_URL = f"{EMINWON_BASE}/emwp/gov/mogaha/ntis/web/ofr/action/OfrAction.do"
DETAIL_URL = f"{EMINWON_BASE}/emwp/jsp/ofr/OfrNotAncmtV.jsp"
SE_CODES = "01,02,04,05,03"
PAGE_SIZE = 10
ORGANIZATION_NAME = "장수군청"
