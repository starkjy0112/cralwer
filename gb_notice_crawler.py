...
"""
경상북도청 알림마당 크롤러
https://www.gb.go.kr/Main/page.do?mnu_uid=6786&LARGE_CODE=720&MEDIUM_CODE=50&SMALL_CODE=10&SMALL_CODE2=10
...
class GBNoticeCrawler:
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[경상북도청 알림마당] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = GBNoticeCrawler()
    print("=== 전체 조회 (3페이지) ===")
