...
"""
군위군청 입찰정보 크롤러
https://www.gunwi.go.kr/ko/page.do?mnu_uid=102&boardType=notice&board_code=02
    ...
    def _fetch_page(self, keyword, page):
        ...
        for tr in rows:
            ...
            if href.startswith("?"):
                ...
                detail_url = f"{LIST_URL}?mnu_uid=102"
