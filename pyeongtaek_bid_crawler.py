...
"""
평택시청 입찰공고 크롤러
https://www.pyeongtaek.go.kr/pyeongtaek/saeol/gosi/list.do?mid=0401030000
GET 기반, 10건/페이지
...
class PyeongtaekBidCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            detail_url = f"{LIST_URL}?mid=0401030000&seCode=02"
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[평택시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = PyeongtaekBidCrawler()
    print("=== '공고' 검색 ===")
