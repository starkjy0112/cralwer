...
LIST_URL = f"{BASE_URL}/nbgosi/list"
PAGE_SIZE = 10


class BusanGosiCrawler:
    """부산광역시청 고시공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page, start_date=None, end_date=None):
        params = {
            "curPage": page,
            "conIfmStdt": start_date if start_date else "2021-01-01",
            "conIfmEnddt": end_date if end_date else "2030-12-31",
            "conGosiGbn": "",
            "schKeyType": "A",
            "srchText": keyword,
        }
        ...
        # 총 건수: "총 <b class="totalNum">1679</b>건"
        total_count = 0
        total_el = soup.select_one("b.totalNum")
        if total_el:
        ...
        for row in rows:
            ...
            items.append({
                ...
                "date": date_str,
                "url": detail_url,
                "organization": dept if dept else "부산광역시청",
            })
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[부산광역시청] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = BusanGosiCrawler()
    print("=== 전체 조회 (3페이지) ===")
