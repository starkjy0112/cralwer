...
"""
성주군청 고시/공고 크롤러
https://www.sj.go.kr/page.do?mnu_uid=1044
GET 기반, table.bod_list, 24건/페이지
컬럼: 번호, 담당부서, 제목, 파일, 작성일, 조회
"""
import math
import re
...
BASE_URL = "https://www.sj.go.kr"
LIST_URL = f"{BASE_URL}/page.do"
PAGE_SIZE = 24
ORGANIZATION_NAME = "성주군청"


class SeongjuCrawler:
    """성주군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for tr in rows:
            ...
            href = a_tag.get("href", "")
            if href.startswith("page.do"):
                detail_url = f"{BASE_URL}/{href}"
            elif href.startswith("/"):
                detail_url = f"{BASE_URL}{href}"
            else:
                detail_url = f"{LIST_URL}?mnu_uid=1044"
