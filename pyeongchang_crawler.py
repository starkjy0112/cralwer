...
GET 기반, form mForm, 15건/페이지
컬럼: 번호, 제목, 작성부서, 등록일, 조회수
"""
import math
import re
import requests
...
BASE_URL = "https://www.pc.go.kr"
LIST_URL = f"{BASE_URL}/portal/government/government-notification"
PAGE_SIZE = 15
ORGANIZATION_NAME = "평창군청"


class PyeongchangCrawler:
    """평창군청 일반공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        total_count = 0
        items = []
        table = soup.select_one("table.skinTb") or soup.select_one("table")
        if not table:
