...
BASE_URL = "https://www.namhae.go.kr"
LIST_URL = f"{BASE_URL}/modules/saeol/gosi.do"
PAGE_CD = "SM010110000"
PAGE_SIZE = 10
ORGANIZATION_NAME = "남해군청"
...
class NamhaeCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        links = [a for a in items_div.select("a") if "amode=" in a.get("href", "")]
        for a in links:
            href = a.get("href", "")
