...
LIST_URL = f"{BASE_URL}/portal/tblSeolGosiDetailList.do"
DETAIL_URL = f"{BASE_URL}/portal/tblSeolGosiDetailView.do"
PAGE_SIZE = 10
ORGANIZATION_NAME = "금천구청"
KEY = "294"


class GeumcheonGosiCrawler:
    """금천구청 고시공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        if table:
            ...
            for tr in rows:
                ...
                if len(tds) < 5:
                    continue
                # 번호, 고시공고번호, 고시공고제목, 담당부서, 등록일, 게재기간
                ...
                if href.startswith("./"):
                    detail_url = BASE_URL + "/portal/" + href[2:]
