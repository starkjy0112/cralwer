...
GET 기반, table.board-list-table, 10건/페이지, pageIndex 파라미터
"""
import math
import re
import requests
...
BASE_URL = "https://www.miryang.go.kr"
LIST_URL = f"{BASE_URL}/web/eMiryangMinwonList.do"
MN_NO = "20903000000"
PAGE_SIZE = 10
ORGANIZATION_NAME = "밀양시청"


class MiryangCrawler:
    """밀양시청 고시·공고·채용 크롤러"""
