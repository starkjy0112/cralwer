...
"""
동두천시청 입찰공고 크롤러
https://www.ddc.go.kr/ddc/selectGosiList.do?key=1307&not_ancmt_se_code=02
GET 기반, 10건/페이지
"""
import math
import re
...
class DongducheonBidCrawler:
    ...
    def search(self, keyword="", max_pages=10, start_date=None, end_date=None):
        ...
        print(f"[동두천시청 입찰공고] 완료: 총 {len(all_items)}건")
        return all_items


if __name__ == "__main__":
    crawler = DongducheonBidCrawler()
    print("=== '공고' 검색 ===")
