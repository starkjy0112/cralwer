...
class GwacheonGosiCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        resp = self.session.post(LIST_URL, data=data, params={"mId": "0301040000"}, timeout=15)
        resp.encoding = "utf-8"
        soup = BeautifulSoup(resp.text, "lxml")

        # Parse total pages from "현재 페이지 1 / 전체 페이지 1218"
        total_count = 0
