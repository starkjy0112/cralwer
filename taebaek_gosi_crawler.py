...
GET 기반, bbs_default list, 10건/페이지
컬럼: 번호, 제목, 작성자, 게시일, 조회수
"""
import math
import re
...
class TaebaekGosiCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            title_td = row.select_one("td.subject") or tds[1]
