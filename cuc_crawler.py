...
"""
춘천도시공사 공지사항 크롤러
https://www.cuc.or.kr/listBoard.do?divId=110
GET 기반, 10건/페이지
"""
import math
import re
...
class CUCCrawler:
    ...
    def _fetch_page(self, keyword, page):
        ...
        for li in soup.select("li.board-list-box"):
            ...
            detail_url = f"{BASE_URL}/viewBoard.do?divId=110&nttId={data_id}" if data_id else ""
    ...
    def search(self, keyword="", max_pages=10):
        ...
        print(f"[춘천도시공사] 완료: 총 {len(all_items)}건")
        return all_items
