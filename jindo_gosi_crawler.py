...
GET 기반, table 5열 (번호/부서/제목/일자/조회), pageIndex, act=view 상세
"""
import math
import re
import requests
...
LIST_URL = f"{BASE_URL}/home/gosi/general.cs"
PAGE_SIZE = 10
ORGANIZATION_NAME = "진도군청"


class JindoGosiCrawler:
    """진도군청 고시/공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        params = {"m": "24", "pageIndex": str(page)}
        if keyword:
