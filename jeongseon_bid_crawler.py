...
"""
정선군청 입찰정보 크롤러
https://www.jeongseon.go.kr/portal/openadmin/adminnews/tenderinfo
    ...
    def _fetch_page(self, keyword, page):
        ...
        for row in rows:
            ...
            items.append({
                ...
                "title": title,
                "date": date,
                "url": "https://www.jeongseon.go.kr/portal/openadmin/adminnews/tenderinfo",
