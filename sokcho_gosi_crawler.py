...
POST 기반 (mForm), 15건/페이지 (recordCountPerPage=100 지원)
table.skinTb
"""
import math
import re
...
LIST_URL = f"{BASE_URL}/sc/portal/sokchonews/notification"
PAGE_SIZE = 100
ORGANIZATION_NAME = "속초시청"


class SokchoGosiCrawler:
    """속초시청 고시공고 크롤러"""
    ...
    def _fetch_page(self, keyword, page):
        ...
        for tr in rows:
            ...
            # onclick에서 article seq 추출하거나 href 사용
